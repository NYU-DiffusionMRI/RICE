...
One can represent low-b data with the O(b) cumulant expansion as shown in Eq. (1). This is DTI, and it can represent DWIs up to ~b=1200 ms/mm^2 for the in vivo human brain.
For higher b-values (up to ~b=2500 ms/mm^2), one can represent the DWIs with the O(b^2) cumulant expansion shown in Eq. (2). This is DKI/QTI depending on the B used.
