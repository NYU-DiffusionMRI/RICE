...
## Example use cases
The [example_RICE.m](https://cai2r.net/resources/standard-model-of-diffusion-in-white-matter-the-smi-toolbox/](https://github.com/NYU-DiffusionMRI/RICE/blob/main/example_RICE.m) script shows some examples on how to run the RICE fitting. Briefly:
```
